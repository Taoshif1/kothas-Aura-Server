...
import { createProduct, deleteProduct, getAdminProductById, getAdminProducts, getProductById, getProducts, updateProduct } from "./product.controller.js";
...
router.get("/admin/:id", verifyJWT, verifyAdmin, asyncHandler(getAdminProductById));
